        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
          {(user && post && (
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900 group-hover:underline">{user.fullname}</p>
                <p className="text-xs text-gray-600">{title}</p>
              </div>
            </div>
          )) ||
            (post && <p className="text-sm text-gray-600">Loading user...</p>)}
        ...
        {post && (
          <div className="p-4 border-b border-gray-200">
            <p
              ...
              className="text-sm text-primary-700 hover:text-primary-800 cursor-pointer font-medium"
            >
              See original post
            </p>
          </div>
